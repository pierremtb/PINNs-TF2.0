...
from burgersutil import prep_data, Logger, plot_inf_disc_results
...
x, t, dt, \
  ...
  IRK_weights, IRK_times = prep_data(path, N_n=hp["N_n"], q=hp["q"], lb=lb, ub=ub, noise=0.0, idx_t_0=idx_t_0, idx_t_1=idx_t_1)
